...
import (
	"github.com/Vodka479/elden-shop-tutorial/pkg/eldenlogger"
...
func (r *Response) Success(code int, data any) IResponse {
	r.StatusCode = code
	r.Data = data
	eldenlogger.InitEldenLogger(r.Context, &r.Data).Print().Save()
	return r
}
func (r *Response) Error(code int, tractId, msg string) IResponse {
	...
	r.IsError = true
	eldenlogger.InitEldenLogger(r.Context, &r.ErrorRes).Print().Save()
	return r
}
